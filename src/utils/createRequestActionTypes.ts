...
export const createRequestActionTypes = (method: XHRMethod, actionName: string) => ({
  ...
  FAILURE: `${createRequestActionType(method, actionName)}_${RequestActionStatuses.Failure}`,
});
